...
REM %python% %script_path%/GeoRefTerrain.py data/images --kml out/points_only.kml --shp_points out/points_only.shp --no_folder
REM %python% %script_path%/GeoRefTerrain.py data/images --gpx data/Trace_OsmTracker.gpx --kml out/track-OSMTracker_and_points.kml --shp_points out/points.shp --shp_lines out/lines.shp
